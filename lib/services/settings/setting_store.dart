...
class SettingStore extends ChangeNotifier {
  ...
  String _appStyle = 'material3'; // 'material3' 或 'liquid_glass'
  ...
  Future<void> _loadSettings() async {
    ...
    _appStyle = prefs.getString('appStyle') ?? 'material3';
    _initialized = true;
  ...
  Future<void> _saveSettings() async {
    ...
    await prefs.setString('appStyle', _appStyle);
  }
}
